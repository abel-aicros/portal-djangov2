...
function inicilizacionSlider(nombre,tiempo,automata){
    console.log("inicilizacion de slider "+ nombre+" "+tiempo)
    console.log('evento');
...
///////////////////////////////////////////////////////////////////////////////////////////
function resise(e){
    console.log(document.documentElement.clientWidth, 'resizee');
...
function documenoresise(){
    ...
    if(window.PaginaActual.PaginaActual== "Documentos"){
        console.log("documenoresis, columnjs = "+ window.columnajs.columnajs);
...
function EditarDocumento(columnas){
    console.log("documento resis with" + columnas);
